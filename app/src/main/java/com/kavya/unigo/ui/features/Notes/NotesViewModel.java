...
public class NotesViewModel extends ViewModel {
    ...
    /*public void uploadImage(Context context, Uri uri) {
        ...
        if (auth.getCurrentUser() == null) {
            uploadState.setValue(new NotesState.Error("User not authenticated"));
            return;
        }
        ...
        try {
            ...
            SupabaseApi api = SupabaseClient.getInstance();
            ...
            call.enqueue(new Callback<Void>() {
                ...
                public void onResponse(Call<Void> call, Response<Void> response) {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        String publicUrl =
                                "https://jxwggiqfdyppaztteasy.supabase.co/storage/v1/object/public/Images/"                                        + fileName;

                        saveToFirestore(uid, publicUrl);
                        ...
                        try {
                            ...
                            uploadState.setValue(
                                    new NotesState.Error("Code: " + response.code() + "\n" + errorBody)
                            );
